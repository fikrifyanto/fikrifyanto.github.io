...
export default function Home() {
    ...
    return (
        <>
            <div
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center z-10 overflow-hidden">
                    ...
                    <div className="text-center transition duration-300 translate-y-96" id="title">
                        <h1 className="">
              <span
                  className="text-3xl md:text-7xl font-acorn text-transparent text-stroke-slate-200 text-stroke-2 relative">
                Hi, I&apos;m Fikri.
              </span>
            ...
            <div
                className="max-w-4xl mx-auto min-h-screen px-8 py-20 md:py-40 flex flex-col lg:flex-row justify-center gap-10 text-white">
                    ...
                    <div className="flex flex-col gap-8 lg:gap-14 mt-14">
                        <div className="flex items-start gap-4">
                            <div className="rounded-full p-2 bg-white">
                                <CldImage
                                    src="images/trinity-wizards.webp"
                                    alt="Trinity Wizards Logo"
                                    className="h-8 w-8"
                                    width={60}
                                    height={60}
                                />
                            ...
                            <div>
                                <h3 className="text-xl font-acorn">Web Application Engineer</h3>
                                <div className="font-gt mt-1">Trinity Wizards</div>
                                <div className="font-gt">April 2024 - Present · 1 yrs 3 mos</div>
                                <div className="font-gt">Selangor, Petaling Jaya, Malaysia · Remote</div>
                            </div>
                        </div>
                        <div className="flex items-start gap-4">
                            <div className="rounded-full p-2 bg-white">
                            ...
                            <div>
                                ...
                                <div className="font-gt">Oct 2021 - April 2024 · 2 yrs 5 mos</div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <div className="font-gt">Jun 2020 - Sep 2021 · 1 yrs 4 mos</div>
                                <div className="font-gt">Sumedang, West Java, Indonesia · On-site</div>
                                <h3 className="text-xl font-acorn mt-8 lg:mt-14">Freelance Software Engineer</h3>
                                <div className="font-gt">Jun 2019 - Present · 5 yrs</div>
                ...
                <div className="px-8 md:h-screen py-20 md:py-40 relative overflow-y-hidden">
                    <div className="max-w-4xl mx-auto -mt-4">
                        <div className="flex flex-col md:flex-row justify-between">
                            <div className="flex-1">
                                ...
                                <p className="text-sm md:text-lg text-white text-left mt-4">
                                    Journify is a travel and lifestyle platform that helps users discover and book
                                    personalized experiences, offering curated recommendations, travel deals, and
                                    seamless trip planning in one place.
                                </p>
                            </div>
                            <div className="flex lg:block gap-2 flex-wrap">
                                <a
                                    href="https://myjournify.com"
                                    target="_blank"
                        ...
                        <div className="flex flex-wrap gap-3 mt-4">
                            ...
                            <div className="rounded-full px-4 text-white border-2 border-white/50">Magento</div>
                        ...
                        <div className="flex flex-col gap-6 mt-10 md:mt-20 md:ml-44 group">
                            ...
                            <CldImage
                                ...
                                src="images/journify/mobile-2.webp"
                                width={400}
                                height={600}
                            ...
                            <CldImage
                                ...
                                src="images/journify/mobile-1.webp"
                                width={400}
                                height={600}
                                style={{width: 150, height: 300}}
                                alt="Waste4change"
                            ...
                            <CldImage
                                ...
                                src="images/journify/mobile-3.webp"
                                width={400}
                                height={600}
                                style={{width: 150, height: 300}}
                                alt="Waste4change"
                    ...
                    <div
                        className="-rotate-[30.6deg] w-[300px] -mt-[10rem] h-[calc(600px*7)] hidden md:flex flex-col gap-10 absolute inset-y-0 left-[57%]">
                        {(() => {
                            const images = []
                            for (let i = 1; i <= 7; i++) {
                                images.push(
                                    <CldImage
                                        ...
                                        src={`images/journify/mobile-${i}.webp`}
                                        width={700}
                                        height={1000}
                        ...
                        <div className="flex flex-col md:flex-row justify-between">
                            <div>
                                ...
                                <p className="text-lg text-white text-left mt-4">
                                    I’m currently developing a multi-service application that offers Repair Service,
                                    Home Service, E-Commerce for spare parts, Tax Services, Vehicle Inspection, and Auto
                                    Care—all in one integrated platform.
                                </p>
                            </div>
                        </div>
                        <div className="flex flex-wrap gap-3 mt-4">
                            ...
                            <div className="rounded-full px-4 text-white border-2 border-white/50">Filament</div>
                        </div>
                            ...
                            for (let i = 0; i <= 6; i++) {
                                images.push(
                                    <CldImage
                                        ...
                                        key={i}
                                        className="rounded-xl banner"
                                        src={`images/pincar/${i}.webp`}
                                        width={700}
                                        height={1000}
                                        style={{width: 300, height: 600}}
                                        alt={`PinCar Screenshot ${i + 1}`}
                                    />
                                )
                            }
                            return images
                    ...
                    <div className="max-w-4xl mx-auto -mt-4">
                        <div className="flex flex-col md:flex-row justify-between">
                            <div className="flex-1">
                                ...
                                <p className="text-sm md:text-lg text-white text-left mt-4">
                                    Repair Project is an Indonesian initiative focused on eliminating low-value
                                    plastic waste through innovation and collaboration. By transforming materials often
                                    overlooked or deemed non-recyclable, the project contributes to environmental
                                    sustainability and fosters community engagement.
                                </p>
                            </div>
                            <div className="flex lg:block gap-2 flex-wrap">
                                <a
                                    href="https://repairproject.id"
                                    target="_blank"
                                    className="flex justify-between text-white font-semibold font-gt gap-2 mt-8 bg-lime-900/30 hover:bg-lime-900/50 py-2 px-6 rounded-full">
                                    View on Web
                                    <svg
                        ...
                        <div className="flex flex-col gap-6 mt-10 md:mt-20 md:ml-44 group">
                            <CldImage
                                loading="lazy"
                                className="rounded-lg shadow-xl transition-all ml-auto md:ml-0 md:group-hover:rotate-0 md:-rotate-12 md:group-hover:-ml-20"
                                src="images/repairproject/1.webp"
                                width={600}
                                height={400}
                                style={{width: 300, height: 170}}
                                alt="Waste4change"
                            ...
                            <CldImage
                                loading="lazy"
                                className="rounded-lg shadow-xl transition-all mr-auto -mt-20 md:group-hover:-mt-44 md:group-hover:rotate-0 md:ml-40 md:rotate-12 md:-mt-32"
                                src="images/repairproject/2.webp"
                                width={600}
                                height={400}
                                style={{width: 300, height: 170}}
                                alt="Waste4change"
                            ...
                            <CldImage
                                loading="lazy"
                                className="rounded-lg shadow-xl transition-all ml-auto -mt-20 md:group-hover:-mt-52 md:group-hover:rotate-0 md:rotate-12 md:ml-80 md:-mt-72"
                                src="images/repairproject/3.webp"
                                width={600}
                                height={400}
                                style={{width: 300, height: 170}}
                                alt="Waste4change"
                            ...
                            <CldImage
                                loading="lazy"
                                className="rounded-lg shadow-xl transition-all ml-auto -mt-40 md:-mt-32 md:ml-auto md:-rotate-12 md:group-hover:rotate-0"
                                src="images/repairproject/mobile-2.webp"
                                width={400}
                                height={600}
                                style={{width: 150, height: 300}}
                                alt="Waste4change"
                            ...
                            <CldImage
                                loading="lazy"
                                className="rounded-lg shadow-xl transition-all ml-auto mr-8 -mt-40 md:-mt-96 md:ml-auto md:-mr-20 md:rotate-12 md:group-hover:rotate-0"
                                src="images/repairproject/mobile-1.webp"
                                width={400}
                                height={600}
                                style={{width: 150, height: 300}}
                                alt="Waste4change"
                            ...
                            <CldImage
                                loading="lazy"
                                className="md:hidden rounded-lg shadow-xl transition-all ml-auto mr-16 -mt-40 md:-mt-96 md:ml-auto md:-mr-20 md:rotate-12 md:group-hover:rotate-0"
                                src="images/repairproject/mobile-3.webp"
                                width={400}
                                height={600}
                                style={{width: 150, height: 300}}
                                alt="Waste4change"
                            ...
                            for (let i = 1; i <= 7; i++) {
                                images.push(
                                    <CldImage
                                        ...
                                        key={i}
                                        className="rounded-xl banner"
                                        src={`images/repairproject/mobile-${i}.webp`}
                                        width={700}
                                        height={1000}
                                        style={{width: 300, height: 600}}
                                        alt={`Waste4change Mobile Screenshot ${i + 1}`}
                    ...
                    <div className="max-w-4xl mx-auto -mt-4">
                        <div className="flex flex-col md:flex-row justify-between">
                            <div className="flex-1">
                                ...
                                <p className="text-lg text-white text-left mt-4">
                                    Send Your Waste is a platform that helps users easily
                                    schedule and track recyclable waste pickups, supporting responsible waste management
                                    and sustainability efforts in Indonesia.
                                </p>
                            </div>
                            <div className="flex lg:block gap-2 flex-wrap">
                                <a
                    ...
                    <div className="max-w-4xl mx-auto -mt-4">
                        <div className="flex flex-col md:flex-row justify-between">
                            <div>
                                ...
                                <p className="text-sm md:text-lg text-white text-left mt-4">
                                    Waste4Change is an Indonesian waste management company focused on promoting
                                    sustainability through responsible waste collection, recycling, and education to
                    ...
                    <div className="max-w-4xl mx-auto -mt-4">
                        <div className="flex flex-col md:flex-row justify-between">
                            <div>
                                ...
                                <p className="text-lg text-white text-left mt-4">
                                    The Waste4Change blog offers insights on sustainable waste management, recycling,
                                    and eco-friendly practices to help individuals and businesses reduce their
                    ...
                    <div className="max-w-4xl mx-auto -mt-4">
                        <div className="flex flex-col md:flex-row justify-between">
                            <div>
                                ...
                                <p className="text-sm md:text-lg text-white text-left mt-4">
                                    Daur.id is an Indonesian waste management company that provides waste collection,
                                    sorting, and recycling services, promoting sustainability through eco-friendly
                                    practices. They serve various sectors, including residential, commercial, and
                                    events, helping reduce environmental impact.
                                </p>
                            </div>
                            <div className="flex lg:block gap-2 flex-wrap">
                                <a
                        ...
                        <div className="flex flex-col gap-6 mt-10 md:mt-20 md:ml-44 group">
                            ...
                            <CldImage
                                loading="lazy"
                                className="rounded-lg shadow-xl transition-all ml-auto -mt-40 md:-mt-32 md:ml-auto md:-rotate-12 md:group-hover:rotate-0"
                                src="images/daur.id/mobile-2.webp"
                                width={400}
                                height={600}
                                style={{width: 150, height: 300}}
                                alt="Daur.id"
                            ...
                            <CldImage
                                loading="lazy"
                                className="rounded-lg shadow-xl transition-all ml-auto mr-8 -mt-40 md:-mt-96 md:ml-auto md:-mr-20 md:rotate-12 md:group-hover:rotate-0"
                                src="images/daur.id/mobile-1.webp"
                                width={400}
                                height={600}
                                style={{width: 150, height: 300}}
                                alt="Daur.id"
                            ...
                            <CldImage
                                loading="lazy"
                                className="md:hidden rounded-lg shadow-xl transition-all ml-auto mr-16 -mt-40 md:-mt-96 md:ml-auto md:-mr-20 md:rotate-12 md:group-hover:rotate-0"
                                src="images/daur.id/mobile-3.webp"
                                width={400}
                                height={600}
                                style={{width: 150, height: 300}}
                                alt="Daur.id"
                            ...
                            for (let i = 1; i <= 7; i++) {
                                images.push(
                                    <CldImage
                                        ...
                                        key={i}
                                        className="rounded-xl banner"
                                        src={`images/daur.id/mobile-${i}.webp`}
                                        width={700}
                                        height={1000}
                                        style={{width: 300, height: 600}}
                                        alt={`Daur.id Mobile Screenshot ${i + 1}`}
                                    />
                                )
                            }
                            return images
                    ...
                    <div className="max-w-4xl mx-auto -mt-4">
                        <div className="flex flex-col md:flex-row justify-between">
                            <div className="flex-1">
                                ...
                                <p className="text-lg text-white text-left mt-4">
                                    JDIH Sumedang is a platform providing access to regional legal documents and
                                    regulations of Sumedang Regency. The JDIH Sumedang app, available on the Play Store,
                                    allows users to easily access and stay updated on legal information and news from
                ...
                <div id="contact" className="relative h-screen w-screen flex items-center justify-center">
                    <div>
                        ...
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-4">
                            ...
                            <a
                                href="https://docs.google.com/document/d/1sz1f7SO1BhioIDGIV5ase-OHLNeKLM-QYXKOuCyZxGE/edit?usp=drive_link"
                                target="_blank"
